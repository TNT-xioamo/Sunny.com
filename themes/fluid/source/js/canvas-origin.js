! function () {
  ...
  animateDots();
  setInterval(() => {
    let stochasticX = parseInt(Math.random() * 1000, 10)
    let stochasticY = parseInt(Math.random() * 600, 10)
    mousePosition.x = stochasticX;
    mousePosition.y = stochasticY;
  }, 1500);
  // Dom.onmousemove = function (ev) {
  //   console.log(ev)
  //   var ev = ev || window.event;
  //   mousePosition.x = ev.offsetX * 15;
  //   mousePosition.y = ev.offsetY * 25;
  // }
  // Dom.onmouseout = function () {
  //   mousePosition.x = 15 * can.width / 2;
  //   mousePosition.y = 25 * can.height / 2;
  // }
}();
